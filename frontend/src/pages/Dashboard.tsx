    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {(['Cloud Practitioner', 'AI Practitioner', 'Solutions Architect'] as const).map((cert) => (
            <div
              key={cert}
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white text-sm">{cert}</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Practice questions coming soon</p>
            </div>
          ))}
        </div>
      </main>
